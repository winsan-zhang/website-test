...
//
////服务器端生成验证码图片
//function buildVerify($width=80, $height=50, $type=1, $length=4, $pixel_num=80, $line_num=6)
//{
//    session_start();
//    //创建画布
...
//    //在画布上画出验证码
//    //定义验证码字体库
//    $fontFileArr = array("msyh.ttc", "msyhbd.ttc", "msyhl.ttc", "simfang.ttf", "simkai.ttf");
//    for ($i = 0; $i < $length; $i++) {
//        $size = mt_rand(16, 20);
//        $angle = mt_rand(-15, 15);
//        $x = 5 + $i * $size;
...
//            mt_rand(1, $width - 1), mt_rand(1, $height - 1), $black);
//    }
//    //清空先前缓存区,这样才会显示图片
//    ob_clean();
//    //先设置头文件，发送到浏览器端
